...
function Nav() {
  return (
    <div className="w-full relative flex flex-1 flex-col border-black z-50">
      ...
      <div className="flex flex-wrap md:flex-nowrap flex-row border-black sm:border-b sm:border-r-0 border-r">
        <div className="pl-1 pr-2 pt-1 sm:pb-1 flex-none border-black sm:border-r">
          <Link to={'/'}>
            <img className="h-9" src="/images/Logo.png" alt="Re:Gear Logo" />
          </Link>
        </div>
        <div className="flex-auto text-wrap px-2 sm:pt-1 pb-1 min-w-56 text-xs border-black sm:border-r sm:border-b-0  border-b">
