...
function Nav() {
  return (
    <div className="w-full relative flex flex-1 flex-col border-black z-50">
      {/* top row of nav in md & 2 rows in sm: logo, subheading // marquee */}
      <div className="flex flex-wrap min-[810px]:flex-nowrap flex-row border-black sm:border-b sm:border-r-0 border-r ">
        ...
        <div className="min-w-0 p-2 border-black border-r hidden sm:block sm:max-[810px]:border-t sm:max-[810px]:border-l">
          <div className="border-black border rounded-md ">
            <StatsMarquee />
          </div>
        </div>
      </div>
      {/* second/third row of nav: NavMenu.tsx */}
